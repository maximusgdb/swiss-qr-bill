...
# Secure API Token
API_TOKEN = [os.getenv("API_TOKEN_1"), os.getenv("API_TOKEN_2"), os.getenv("API_TOKEN_3")]
print(API_TOKEN)
...
def check_auth():
    ...
    return token in API_TOKEN  # Check if the token is in the list of valid tokens
